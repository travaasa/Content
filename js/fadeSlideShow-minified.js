...
if(ActSlide<=0){jQslide.fadeIn(settings.speed);ActSlide=Slides;}else{ActSlide=ActSlide-1;}},settings.interval);if(settings.PlayPauseElement){jQuery('#'+settings.PlayPauseElement).removeClass("btn_pause").addClass("btn_play");}}
stopAutoplay=function(){clearInterval(intval);intval=false;if(settings.PlayPauseElement){jQuery('#'+settings.PlayPauseElement).removeClass("btn_play").addClass("btn_pause");}}
...
if(settings.autoplay){jQuery('#'+settings.PlayPauseElement).addClass("btn_pause");}else{jQuery('#'+settings.PlayPauseElement).removeClass("btn_play").addClass("btn_pause");}
